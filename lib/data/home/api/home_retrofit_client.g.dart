...
class _HomeRetrofitClient implements HomeRetrofitClient {
  ...
  Future<DailyRecommendationExerciseDto> getDailyRecommendationExercise(
    ...
    final _options = _setStreamType<DailyRecommendationExerciseDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<UpcomingWorkoutDto> getUpcomingWorkouts() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UpcomingWorkoutDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<RecommendationMealsDto> getFoodRecommendation() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RecommendationMealsDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<MuscleGroupDto> getAllMuscles() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MuscleGroupDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
