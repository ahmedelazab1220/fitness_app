...
class HomeCubit extends Cubit<HomeState> {
  ...
  Future<void> _getAllMuscles() async {
    ...
    switch (result) {
      case SuccessResult<List<MuscleGroupEntity>?>():
        {
          muscleGroups = result.data!;
          emit(state.copyWith(getAllMuscelsState: BaseSuccessState()));
        }
      case FailureResult<List<MuscleGroupEntity>?>():
        {
          emit(
            state.copyWith(
  ...
  Future<void> _getAllMusclesByGroup() async {
    ...
    final result = await _getAllMusclesByGroupUseCase(Constants.muscleGroupId);
    switch (result) {
